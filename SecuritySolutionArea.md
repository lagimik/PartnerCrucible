...
[ExCyTIn-Bench: Evaluating LLM agents on Cyber Threat Investigation](https://github.com/microsoft/SecRL) | irst benchmark to test LLM-based agents on threat hunting in the form of security question-answering pairs. | GitHub
