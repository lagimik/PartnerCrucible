...
- Added Azure Depth Workshops: View content to deepen your skills through instructor-led training with technical experts. Uncover new insights, learn about architecture and implementation considerations, and find innovative ways to support your customer business challenges. On-demand.
...
- [Microsoft Sales Copilot](https://cloudblogs.microsoft.com/dynamics365/it/2023/07/18/improve-sales-productivity-and-close-more-deals-with-microsoft-sales-copilot/): Sales Copilot is a tool that enhances sales productivity and enables personalized customer interactions. It is compatible with Microsoft Outlook, Teams, and Dynamics 365 Sales, as well as Salesforce.
...
# Microsoft Marketplace - Multiparty Private Offers (MPO)

## What's new

Microsoft has added a new feature called Multiparty Private Offers (MPO) to the Partner Crucible program in order to assist Microsoft partners in building their technical practice. This feature allows partners to collaborate and sell custom solutions on the commercial marketplace.

## Deep links

- [Microsoft Marketplace - Multiparty Private Offers (MPO)](https://www.youtube.com/watch?v=aAD_MhnYGOs): This video provides an overview of how Microsoft is supporting partners in developing custom solutions through multiparty private offers (MPO) on the commercial marketplace.
...
Microsoft has released a new e-book called "FinOps with Azure" that aims to bring FinOps principles to life and help organizations align their practices for maximum cloud business value.

## Deep links

- [FinOps with Azure](https://azure.microsoft.com/en-us/resources/finops-with-azure-bringing-finops-to-life-through-organizational-and-cultural-alignment/en-us/?cdn=disable): This e-book provides guidance on FinOps principles and highlights Microsoft solutions that can support the cloud journey and help organizations maximize their cloud business value.
...
- [Investing in MXDR partner success](https://cloudpartners.transform.microsoft.com/mxdrpartners): Demand for managed extended detection and response (MXDR) services is on a fast growth trajectory. Today, more than 860,000 organizations use Microsoft security products, and according to Gartner, more than 60 percent of organizations will be using managed detection and response (MDR) services for threat monitoring, detection, and response functions that offer threat containment and mitigation capabilities by 2025. Partners play a critical role in addressing this incredible customer demand, and Microsoft is investing in your ability to meet this coming need. (Transform)
