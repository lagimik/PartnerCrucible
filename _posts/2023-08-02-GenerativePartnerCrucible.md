...
- Added the Power Platform PAL Association, which provides a video on how to associate Power Apps customer deployments to the partner organization MCPP ID, helping partners attain the Low Code Application Development Advanced specialization. The video includes a Q&A session and discussion on association in non-production environments.
