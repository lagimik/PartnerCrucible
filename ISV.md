...
[What is the ISV Extensibility Story for Microsoft Copilot?](https://learn.microsoft.com/en-us/microsoft-cloud/dev/copilot/isv-extensibility-story) | n this article, we will explore the ISVs extensibility story for Microsoft Copilot, and how ISVs can leverage the different aspects of the platform to create innovative and engaging experiences for users, as well as some guiding principles for ISVs to consider when choosing extensibility approach is best for their scenarios.| Microsoft Learn
